...
public class Activity_DatosPersonales extends Activity implements View.OnClickListener{
    ...
    LinearLayout btnBorrarDatos = null;
    ImageButton btnBorrarDatos2 = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBorrarDatos = (LinearLayout)findViewById(R.id.btnBorrarDatos);
        btnBorrarDatos.setOnClickListener(this);

        btnBorrarDatos2 = (ImageButton)findViewById(R.id.btnBorrarDatos2);
        btnBorrarDatos2.setOnClickListener(this);
        ...
        spTipoDoc.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                EditText noIden = (EditText)findViewById(R.id.txtNumId);
                ...
                if(!docAnterior.equals(noIden.getText().toString()))
                    noIden.setText("");
    ...
    public void cargarDatosCiudadano(boolean vacios){
        ...
        docAnterior = ciudadano.getDocumento();
    }
    ...
    public void onClick(View view) {
        ...
        if(view == btnBorrarDatos || view == btnBorrarDatos2){
