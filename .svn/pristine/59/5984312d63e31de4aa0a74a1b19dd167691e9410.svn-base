...
public class DBHandlerElemento {
    ...
    {
        createElement(1, "1","t","Lugar o dirección en Manizales donde sucedio el evento","NULL"  ,"1","AN","1","1","NULL","NULL","NULL","NULL");
        ...
        createElement(14, "1","r","Desea incluir una foto?","SN"                        ,"1","NULL","3","1","NULL","NULL","NULL","NULL");
        createElement(15, "1","f","Foto","NULL"                                         ,"1","NULL","3","1","NULL","0","SI","NULL");
        createElement(16, "1","r","Desea incluir un video?","SN"                        ,"1","NULL","3","2","NULL","NULL","NULL","NULL");
        createElement(17, "1","v","Video","NULL"                                        ,"1","NULL","3","2","NULL","0","SI","NULL");
        createElement(18, "1","t","Motivo de la Solicitud","NULL"                       ,"1","AN","3","5","NULL","NULL","NULL","NULL");

        //Tramite 2
        createElement(19, "2","t","Lugar o dirección en Manizales donde sucedio el evento","NULL" ,"1","AN","1","1","NULL","NULL","NULL","NULL");
