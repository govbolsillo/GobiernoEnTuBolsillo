        ...
        if(listaRegistros != null){
            if(listaRegistros.size() > 0){
                ...
                for(int i = 0; i < n; i++){
                    ...
                    //descripcion.setText(registro.getUltimoEstado());
                    ...
                    if(listaRegistros.get(i).getStatus() != null){
                        ...
                        else if(listaRegistros.get(i).getStatus().equals("3")){
                ...
                Toast.makeText(this, "No Se Encontraron Datos registrados", Toast.LENGTH_LONG).show();
            }
        }else{
            Toast.makeText(this, "No Se Encontraron Datos registrados", Toast.LENGTH_LONG).show();
        }
