...
public class DatabaseHandler implements Cloneable{
    ...
    public static DatabaseHandler getInstance() {
        if(instance == null)
        {
            ...
            /*
            String ruta = android.content.res.Resources.getSystem().getString(R.string.pathDB
    ...
    private static void recreateTables() {
        handlerElemento.delTable();
        handlerContexto.delTable();
        handlerTramite.delTable();
        handlerElementoOpcion.delTable();
